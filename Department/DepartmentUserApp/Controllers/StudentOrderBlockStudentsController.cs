...
namespace DepartmentUserApp.Controllers
{
    public class StudentOrderBlockStudentsController : Controller
    {
        ...
        public IActionResult List()
        {
            try
            {
                ViewBag.StudentOrderBlockStudentsList = APIClient.GetRequest<List<StudentOrderBlockStudentViewModel>>("api/StudentOrderBlockStudents/GetStudentOrderBlockStudentList");
        ...
        public IActionResult Details(int id)
        {
            try
            {
                ...
                var item = APIClient.GetRequest<StudentOrderBlockStudentViewModel>($"api/StudentOrderBlockStudents/GetStudentOrderBlockStudent?id={id}");
                if (item == null)
                {
        ...
        public IActionResult Create(StudentOrderBlockStudentBindingModel model)
        {
            try
            {
                ...
                APIClient.PostRequest("api/StudentOrderBlockStudents/StudentOrderBlockStudentCreate", model);
                return RedirectToAction("List");
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Update(StudentOrderBlockStudentBindingModel model)
        {
            try
            {
                ...
                APIClient.PostRequest("api/StudentOrderBlockStudents/StudentOrderBlockStudentUpdate", model);
                return RedirectToAction("List");
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                ...
                APIClient.PostRequest("api/StudentOrderBlockStudents/StudentOrderBlockStudentDelete", new StudentOrderBlockStudentBindingModel
                {
                    Id = id
                });
